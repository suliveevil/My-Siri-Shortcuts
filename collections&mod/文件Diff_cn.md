...
6: 从菜单中选取
7 (6, ): 从菜单中选取 (手动输入)
8: 要求输入 (Q: "输入要对比的原文本", Default: "", Ask for )
9 (6, ): 从菜单中选取 (从文件选择)
10: 获取文件
11 (6, ): 从菜单中选取
12: 设定变量 (old)
